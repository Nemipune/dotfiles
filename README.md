...
I'm using the **Hack** theme from the [polybar-themes](https://github.com/adi1090x/polybar-themes) repo so if I install custom plugins and edit some visual aspects it's probably gonna be there. I'm keeping the rest just in case.
